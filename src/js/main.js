...
require(['ojs/ojbootstrap', 'ojs/ojcontext', 'knockout', 'ojs/ojarraydataprovider', 'ojs/ojknockout', 'ojs/ojinputtext',
  'ojs/ojmessages', 'ojs/ojmessages'],
        ...
        function init() {
          class viewModel {
            constructor() {
              ...
              this.getProcesses = async () => {
                try {
                  await electron.model.raiseNotification(this.msg());
                }
                catch (e) {
                  console.log("Error ", e);
                }
